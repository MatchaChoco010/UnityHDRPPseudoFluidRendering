...
namespace UnityEngine.Experimental.Rendering.HDPipeline {
    public static class HDShaderPassNames {
        ...
        public static readonly string s_MyDepthPassStr = "MyDepthPass";
        public static readonly string s_MyXBlurPassStr = "MyXBlurPass";
        public static readonly string s_MyYBlurPassStr = "MyYBlurPass";
        public static readonly string s_MyGBufferPassStr = "MyGBufferPass";
        ...
        public static readonly ShaderTagId s_MyDepthPassName = new ShaderTagId (s_MyDepthPassStr);
        public static readonly ShaderTagId s_MyXBlurPassName = new ShaderTagId (s_MyXBlurPassStr);
        public static readonly ShaderTagId s_MyYBlurPassName = new ShaderTagId (s_MyYBlurPassStr);
        public static readonly ShaderTagId s_MyGBufferPassName = new ShaderTagId (s_MyGBufferPassStr);
